...
##   $ docker build -t php-for-mattlk13-resourcemanager .
##
## RUNNING
##   $ docker run -p 9000:9000 php-for-mattlk13-resourcemanager
##
## CONNECTING
...
ENV STACKSMITH_STACK_ID="ajf69xt" \
    STACKSMITH_STACK_NAME="PHP for Mattlk13/Resourcemanager" \
